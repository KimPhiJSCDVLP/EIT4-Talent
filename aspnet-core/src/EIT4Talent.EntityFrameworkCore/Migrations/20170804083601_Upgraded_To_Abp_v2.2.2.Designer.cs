...
namespace EIT4Talent.Migrations
{
    ...
    partial class Upgraded_To_Abp_v222
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("EIT4Talent.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EIT4Talent.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("EIT4Talent.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("EIT4Talent.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("EIT4Talent.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("EIT4Talent.Authorization.Users.User", "DeleterUser")
                        .WithMany()
